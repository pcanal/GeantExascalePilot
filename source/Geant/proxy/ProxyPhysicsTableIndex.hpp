...
const std::string ProxyPhysicsTableName[kNumberPhysicsTable] = {
    "DEDX.eBrem.e-.asc",       "DEDX.eBrem.e+.asc",          "DEDX.eIoni.e-.asc",
    "DEDX.eIoni.e+.asc",       "InverseRange.eIoni.e-.asc",  "InverseRange.eIoni.e+.asc",
    "Ionisation.eIoni.e-.asc", "Ionisation.eIoni.e+.asc",    "Lambda.compt.gamma.asc",
    "Lambda.conv.gamma.asc",   "Lambda.eBrem.e-.asc",        "Lambda.eBrem.e+.asc",
    "Lambda.eIoni.e-.asc",     "Lambda.eIoni.e+.asc",        "LambdaMod1.msc.e-.asc",
    "LambdaMod1.msc.e+.asc",   "LambdaPrim.compt.gamma.asc", "LambdaPrim.phot.gamma.asc",
    "Range.eIoni.e-.asc",      "Range.eIoni.e+.asc"};
