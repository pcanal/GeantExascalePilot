...
constexpr double A1p76[ndim][ndim] = {{82758667.0, 1871391091.0, 4127413238.0},
                                      {3672831523.0, 69195019.0, 1871391091.0},
                                      {3672091415.0, 3528743235.0, 69195019.0}};

constexpr double A2p76[ndim][ndim] = {{1511326704.0, 3759209742.0, 1610795712.0},
                                      {4292754251.0, 1511326704.0, 3889917532.0},
                                      {3859662829.0, 4292754251.0, 3708466080.0}};

constexpr double A1p127[ndim][ndim] = {{2427906178.0, 3580155704.0, 949770784.0},
                                       {226153695.0, 1230515664.0, 3580155704.0},
                                       {1988835001.0, 986791581.0, 1230515664.0}};
constexpr double A2p127[ndim][ndim] = {{1464411153.0, 277697599.0, 1610723613.0},
