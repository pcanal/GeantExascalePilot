...
//! Physics
enum class ParticleSpecies : short { Hadron, Lepton };
...
namespace std {
inline std::ostream &operator<<(std::ostream &os, const geantx::TrackStatus &status)
{
  using geantx::TrackStatus;
  switch (status) {
  case TrackStatus::Alive:
    os << "Alive";
    break;
  case TrackStatus::Killed:
    os << "Killed";
    break;
  case TrackStatus::InFlight:
    os << "InFlight";
    break;
  case TrackStatus::Boundary:
    os << "Boundary";
    break;
  case TrackStatus::ExitingSetup:
    os << "ExitingSetup";
    break;
  case TrackStatus::Physics:
    os << "Physics";
    break;
  case TrackStatus::Postponed:
    os << "Postponed";
    break;
